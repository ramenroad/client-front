...
import { type Review, useRamenyaReviewMutation } from "@/entities/review/model";
...
export const CreateReviewPage = () => {
  ...
  const { mutate: createReview, isPending: isSubmitting } = add;
  const { ramenyaDetailQuery } = useRamenyaDetailQuery(id!);
  const { isLoading, isError } = ramenyaDetailQuery;
              ...
              <Controller
                ...
                render={({ field }) => (
                  <ReviewTextAreaContainer>
                    <ReviewDescriptionTextarea maxLength={1000} {...field} placeholder="최소 20자 이상 입력해주세요" />
                    <CharacterCount>
