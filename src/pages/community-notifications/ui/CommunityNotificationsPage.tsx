...
const BackButton = render.button(
  'absolute left-20 top-10 flex h-24 w-24 cursor-pointer items-center justify-center border-none bg-transparent p-0',
)
...
const NotificationMessage = render.div('mt-10 break-words font-14-r text-gray-800')

const NotificationExcerpt = render.div('mt-10 rounded-8 bg-border px-12 py-10 font-14-r text-gray-500')
