...
import { FilterOptions, SortType } from "./filter";
...
export const genrePath = [
  { genre: RAMENYA_TYPES.SHOUYU, image: soy },
  { genre: RAMENYA_TYPES.SIO, image: sio },
  { genre: RAMENYA_TYPES.MISO, image: miso },
  { genre: RAMENYA_TYPES.PIG, image: pig },
  { genre: RAMENYA_TYPES.TSUKEMEN, image: tsukemen },
  { genre: RAMENYA_TYPES.IEKEI, image: iekei },
  { genre: RAMENYA_TYPES.JIRO, image: jiro },
  { genre: RAMENYA_TYPES.TORIPAITAN, image: toripaitan },
  { genre: RAMENYA_TYPES.NIBOSHI, image: niboshi },
  { genre: RAMENYA_TYPES.ABURASOBA, image: aburasoba },
  { genre: RAMENYA_TYPES.DANDAN, image: dandan },
  { genre: RAMENYA_TYPES.MAZEMEN, image: mazemen },
];
