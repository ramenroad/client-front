...
export const ReviewFormFeature = ({ mode }: ReviewFormFeatureProps) => {
  ...
  return (
    <Wrapper>
        ...
        <Form onSubmit={handleSubmitReview}>
          <ContentsWrapper>
            ...
            <ReviewMenuSection
              ...
              onCustomMenuInputChange={setCustomMenuInput}
              onCustomMenuAdd={handleAddCustomMenu}
              onCustomMenuKeyDown={handleCustomMenuKeyDown}
            />

            <ReviewTextSection control={control} minLength={MIN_REVIEW_LENGTH} maxLength={MAX_REVIEW_LENGTH} />
      ...
      <Modal isOpen={backModal.isOpen} onClose={handleCancelBack}>
        <ModalContent>
      ...
      <Modal isOpen={loginModal.isOpen} onClose={loginModal.close}>
        <ModalContent>
          ...
          <ModalButtonBox>
            <ModalCancelButton type="button" onClick={loginModal.close}>
              취소
            </ModalCancelButton>
