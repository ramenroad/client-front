    ...
    <Wrapper>
      ...
      <TermsAndConditions>
        ...
        <RaisingText size={12} weight="r">
          Copyright © 2026 라이징 All rights reserved.
        </RaisingText>
      </TermsAndConditions>
...
const Wrapper = render.div(
  "w-full h-212 p-20 box-border bg-footer text-gray-500 font-14-r flex flex-col gap-24",
);
...
const StrongLink = render.a(
  "font-12-sb cursor-pointer text-gray-500 no-underline",
);

const InstagramLink = render.a("w-fit");

const InstagramIcon = render.extend(
  IconInstagram,
