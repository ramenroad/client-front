...
export const IconNotification = (props: ComponentProps<"svg"> & { activate?: boolean }) => {
  const { activate = false, ...rest } = props;
  ...
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      {activate && <circle cx="22" cy="4" r="2" fill="#FF5454" />}
    </svg>
  );
};

export const IconPen = (props: ComponentProps<"svg">) => (
  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      d="M18.0351 6.42976C18.4256 6.03924 19.0588 6.03924 19.4493 6.42976L21.5706 8.55108C21.9611 8.94161 21.9611 9.57477 21.5706 9.9653L13.1977 18.3382C13.0614 18.4745 12.8886 18.5685 12.7002 18.6089L10.0003 19.1874C9.29102 19.3394 8.66097 18.7094 8.81296 18.0001L9.3915 15.3002C9.43189 15.1117 9.52589 14.939 9.66219 14.8026L18.0351 6.42976Z"
      fill="white"
    />
    <rect x="10.2598" y="14.21" width="5" height="1" transform="rotate(45 10.2598 14.21)" fill="#FF5E00" />
    <rect x="8" y="23" width="14" height="1" rx="0.5" fill="white" />
  </svg>
);

export const IconEyeArticle = (props: ComponentProps<"svg">) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      d="M8.00159 9.31951C9.05958 9.31951 9.91725 8.51072 9.91725 7.51303C9.91725 6.51533 9.05958 5.70654 8.00159 5.70654C6.94361 5.70654 6.08594 6.51533 6.08594 7.51303C6.08594 8.51072 6.94361 9.31951 8.00159 9.31951Z"
      stroke="#A0A0A0"
    />
    <path
      d="M13.2289 6.87096C13.4767 7.15518 13.6006 7.29669 13.6006 7.51287C13.6006 7.72904 13.4767 7.87055 13.2289 8.15477C12.3222 9.1929 10.3223 11.1258 8.00049 11.1258C5.67871 11.1258 3.67877 9.1929 2.77203 8.15477C2.52427 7.87055 2.40039 7.72904 2.40039 7.51287C2.40039 7.29669 2.52427 7.15518 2.77203 6.87096C3.67877 5.83284 5.67871 3.8999 8.00049 3.8999C10.3223 3.8999 12.3222 5.83284 13.2289 6.87096Z"
      stroke="#A0A0A0"
    />
  </svg>
);

export const IconLikeArticle = (props: ComponentProps<"svg">) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <path
      d="M5.52083 3.5415C3.99075 3.5415 2.75 4.85984 2.75 6.48559C2.75 9.73942 8 13.4582 8 13.4582C8 13.4582 13.25 9.73942 13.25 6.48559C13.25 4.47134 12.0092 3.5415 10.4792 3.5415C9.39417 3.5415 8.455 4.20417 8 5.169C7.545 4.20417 6.60583 3.5415 5.52083 3.5415Z"
      stroke="#A0A0A0"
      strokeLinecap="round"
      strokeLinejoin="round"
    />
...
export const IconCommentArticle = (props: ComponentProps<"svg">) => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <rect x="2.5" y="3.5" width="11" height="9" rx="0.5" stroke="#A0A0A0" />
    <rect x="5.25" y="6.25" width="5.5" height="0.5" rx="0.25" stroke="#A0A0A0" stroke-width="0.5" />
